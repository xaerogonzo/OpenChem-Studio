...
from openchem.vendor.iupac_namer.ring_naming.kekule_store import maybe_rewrite_for_kekule
from openchem.vendor.iupac_namer.types import Locant, Numbering, NamedParent
...
def _build_curated_from_data_loader() -> tuple[
    ...
    for smiles, record in _RING_CURATED_SMILES.items():
        ...
        if atom_locants:
            ...
            from openchem.vendor.iupac_namer.ring_naming.fusion_locants import (
...
def try_retained_name(
    ...
    """
    from openchem.vendor.iupac_namer.ring_naming.common import extract_ring_mol, extract_ring_mol_with_exo_oxo
    ...
    if match_name is None:
        from openchem.vendor.iupac_namer.ring_naming.common import extract_ring_mol_stripping_exo_oxo
