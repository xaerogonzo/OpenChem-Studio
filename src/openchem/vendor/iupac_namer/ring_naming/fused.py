...
def _try_multiring_base_name_and_numberings(
    ...
    """
    from openchem.vendor.iupac_namer.ring_naming.retained_lookup import try_retained_name
    from openchem.vendor.iupac_namer.types import RingSystem as RS, FusionInfo
...
def name_fused(
    ...
    from openchem.vendor.iupac_namer.ring_naming.fusion_general import name_fusion_parents
