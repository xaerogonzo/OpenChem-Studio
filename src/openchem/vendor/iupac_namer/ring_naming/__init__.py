...
def name_ring_system(
    ...
    try:
        match rs_type:
            case "monocyclic":
                from openchem.vendor.iupac_namer.ring_naming.monocyclic import name_monocyclic
            ...
            case "bridged":
                ...
                from openchem.vendor.iupac_namer.ring_naming.spiro import name_polycyclic_spiro
                ...
                # OPSIN round-trip.
                from openchem.vendor.iupac_namer.ring_naming.benzo_fused_bridged import (
