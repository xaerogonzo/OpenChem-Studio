...
def _retained_carbocyclic_ring_cation_smiles() -> frozenset[str]:
    ...
    *retained* ``-ylium`` PIN (phenylium, cyclopentadienylium).
    ...
    from openchem.vendor.iupac_namer.data_loader import get_rings_from_opsin
...
def detect(
    ...
    * the classification's site atoms cover *every* charged atom in
    ...
    try:
        ...
        from openchem.vendor.iupac_namer.data_loader import _lookup_curated_inorganic as _lic
...
def _render_acidic_anion(
    ...
    from openchem.vendor.iupac_namer.types import OutputForm
...
def _render_carbamate_anion(
    ...
    from rdkit import Chem
    from openchem.vendor.iupac_namer.engine import name as _recursive_name
    from openchem.vendor.iupac_namer.assembly import assemble, _carbamic_n_subs_to_prefix
...
def _render_azaniumyl(
    ...
    """
    from rdkit import Chem
    from openchem.vendor.iupac_namer.engine import name as _recursive_name, NamingSession
    from openchem.vendor.iupac_namer.assembly import assemble
    from openchem.vendor.iupac_namer.types import OutputForm, FreeValenceInfo
