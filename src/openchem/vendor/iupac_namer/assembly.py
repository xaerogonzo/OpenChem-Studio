...
from openchem.vendor.iupac_namer.data_loader import ACID_ADJECTIVE_TABLE, get_multiplier

# NameTree union -- not imported directly to avoid circular imports; used only for type hints
if TYPE_CHECKING:
    from openchem.vendor.iupac_namer.types import NameTree
    ...
    if tree.suffix_groups:
        ...
        if (_ih_match
            ...
            if ih_locant_str != suf_locant_str:
                # Build the IH locant.
                from openchem.vendor.iupac_namer.types import Locant as _Locant
