...
| serialization | a multiplied simple prefix enclosed, and a lone prefix in parentheses | `(2-hydroxyethyl)di(methyl)silanol`, `methoxydi(methyl)silanol`, `[(hydroxy)di(methyl)silyl]acetic acid` | `...dimethylsilanol`, `[hydroxy(dimethyl)silyl]acetic acid`, as in "dimethylsilanediol (PIN)" (p. 748) | the silanol and silyl-prefix routes enclose every component; the plain route already writes `dimethylsilanediol`. N8 (D-091i, j, s carry today's form) |
