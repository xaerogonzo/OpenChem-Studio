...
161/165 — see `BENCHMARK_HISTORY.md`.) That
...
Current state: **3,075 passing, 0 failing, 16 skipped** in ~7 minutes.
...
(phthalaldehyde). **Thirty-two** such cases have been fixed and are pinned in
`tests/test_namer_known_defects.py`, alongside 14 non-regression rows guarding
