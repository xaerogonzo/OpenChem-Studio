...
#: RE-EXPORTED, so the twenty-two modules and tests naming these types are
#: untouched by the move to `domain/`. They are data; the builders below
#: are construction, and only the latter needs `chem`.
from openchem.domain.visualization import (  # noqa: F401
    SURFACE_REPRESENTATION_LABELS,
    SURFACE_REPRESENTATIONS,
    AnyVisualizationLayer,
    ColorScale,
    ResidueColorLayer,
    SurfaceLayer,
    VisualizationLayer,
