...
class TestStripUnsaturationLocants:
    ...
    def test_2carbon_single_en_locant_stripped(self):
        from openchem.vendor.iupac_namer.assembly import _strip_unsaturation_locants_if_omissible
...
class TestRenderedSuffixStartsWithConsonant:
    ...
    def test_triol_has_consonant(self):
        from openchem.vendor.iupac_namer.assembly import _rendered_suffix_starts_with_consonant
...
class TestSaltTree:
    def test_two_ions(self):
        from openchem.vendor.iupac_namer.types import SaltTree
        cation = _leaf("sodium")
...
class TestFreeValenceSuffix:
    ...
    from openchem.vendor.iupac_namer.assembly import render_free_valence_suffix  # type: ignore[attr-defined]
    ...
    def test_methyl_stem_plus_yl_no_hyphen(self):
        ...
        from openchem.vendor.iupac_namer.assembly import render_free_valence_suffix
        fv = self._alkyl_fv()
...
class TestPrefixHyphenInsertion:
    ...
    def test_render_merged_prefixes_hyphen_between_groups(self):
        ...
        from openchem.vendor.iupac_namer.assembly import render_merged_prefixes
